...
TEST_CASE_F1="../vmecpp/src/vmecpp/cpp/vmecpp/test_data/input.cma"
TEST_CASE_F2="../vmecpp/src/vmecpp/cpp/vmecpp/test_data/input.cth_like_fixed_bdy"

# Test case 2: lasym=T (non-axisymmetric) 
TEST_CASE_T1="../VMEC2000/python/tests/input.up_down_asymmetric_tokamak"
TEST_CASE_T2="../educational_VMEC/test/from_MattLandreman_vmec_equilibria/ITER/hybridAxisymmFixedBoundaryNs201/input.ITER_hybridAxisymmFixedBoundaryNs201"
...
timeout 300 fpm run vmec-benchmark -- run --limit 1 --include-file "$TEST_CASE_T2"
